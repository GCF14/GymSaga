            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-col gap-4 ml-8">
                <div className="flex flex-row items-center gap-2">
                  <span className="text-right w-24">Email</span>
                  <Input
                    disabled
                    type="username"
                    placeholder={email ?? ""}
                ...
                <div className="flex flex-row items-center gap-2">
                  <span className="text-right w-24">Username</span>
                  <Input
                    disabled
                    type="username"
                ...
                <div className="flex flex-row items-center gap-2">
                  <span className="text-right w-24">First Name</span>
                  <Input
                    disabled
                    type="first name"
                ...
                <div className="flex flex-row items-center gap-2">
                  <span className="text-right w-24">Last Name</span>
                  <Input
                    disabled
                    type="last name"
